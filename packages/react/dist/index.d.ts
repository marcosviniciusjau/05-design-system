...
declare const ProfilePhotoImage: _stitches_react_types_styled_component.StyledComponent<react.ForwardRefExoticComponent<Avatar.AvatarImageProps & react.RefAttributes<HTMLImageElement>>, {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        gray100: string;
...
interface ProfilePhotoProps extends ComponentProps<typeof ProfilePhotoImage> {
}
declare function ProfilePhoto(props: ProfilePhotoProps): react_jsx_runtime.JSX.Element;
declare namespace ProfilePhoto {
...
export { Box, type BoxProps, Button, type ButtonProps, Checkbox, type CheckboxProps, Heading, type HeadingProps, MultiStep, type MultiStepProps, ProfilePhoto, type ProfilePhotoProps, Text, TextArea, type TextAreaProps, TextInput, type TextInputProps, type TextProps };
